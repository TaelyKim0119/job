...
class _ResultScreenState extends State<ResultScreen>
      ...
      child: GlassCard(
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.auto_awesome, color: AppColors.goldWarm, size: 18),
  ...
  Widget _buildJobCard(JobRecommendation job, int index) {
        ...
        child: GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              border: index == 0
                  ? Border.all(color: AppColors.goldWarm.withValues(alpha: 0.4))
                  : null,
              boxShadow: index == 0
                  ? [BoxShadow(color: AppColors.goldWarm.withValues(alpha: 0.1),
                      blurRadius: 24)]
                  : null,
            ),
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    gradient: LinearGradient(
                      colors: [AppColors.purpleDeep.withValues(alpha: 0.5),
                               AppColors.surface],
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                    ),
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(job.jobName,
                        style: TextStyle(fontSize: index == 0 ? 24 : 20,
                      ...
                      Row(
                        children: [
                          Text('매칭률', style: TextStyle(fontSize: 12,
                              color: AppColors.textTertiary)),
                          const SizedBox(width: 8),
                          Expanded(
                            child: ClipRRect(
                          ...
                          Text('${job.matchScore}%',
                            style: TextStyle(fontSize: 13,
                                fontWeight: FontWeight.w600, color: medalColor)),
                        ],
                      ),
                      const SizedBox(height: 12),
  ...
  Widget _imagePlaceholder() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.image_outlined, size: 40, color: AppColors.textTertiary),
          const SizedBox(height: 8),
          Text('AI 이미지 생성 영역',
